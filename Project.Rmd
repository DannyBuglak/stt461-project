...
```{r}
#QB Linear Models
PassingTD_gm_model <- lm(PassingTD_gm ~ FantasyPoints_gm, data = qb_gm)
PassingYds_gm_model <- lm(PassingYds_gm ~ FantasyPoints_gm, data = qb_gm)
GS_model <- lm(GS ~ FantasyPoints_gm, data = qb_gm)
PassingAtt_gm_model <- lm(PassingAtt_gm ~ FantasyPoints_gm, data = qb_gm)
...
```{r}
#RB Linear Models
Tgt_gm_model <- lm(Tgt_gm ~ FantasyPoints_gm, data = rb_gm)
Rec_gm_model <- lm(Rec_gm ~ FantasyPoints_gm, data = rb_gm)
RushingYds_gm_model <- lm(RushingYds_gm ~ FantasyPoints_gm, data = rb_gm)
RushingTD_gm_model <- lm(RushingTD_gm ~ FantasyPoints_gm, data = rb_gm)
RushingAtt_gm_model <- lm(RushingAtt_gm ~ FantasyPoints_gm, data = rb_gm)
ReceivingYds_gm_model <- lm(ReceivingYds_gm ~ FantasyPoints_gm, data = rb_gm)
ReceivingTD_gm_model <- lm(ReceivingTD_gm ~ FantasyPoints_gm, data = rb_gm)
GS_model <- lm(GS ~ FantasyPoints_gm, data = rb_gm)
...
RushingTD_gm_model
RushingAtt_gm_model
ReceivingYds_gm_model
ReceivingTD_gm_model
GS_model
...
```{r}
#WR Linear Models
GS_model <- lm(GS ~ FantasyPoints_gm, data = wr_gm)
Tgt_gm_model <- lm(Tgt_gm ~ FantasyPoints_gm, data = wr_gm)
Rec_gm_model <- lm(Rec_gm ~ FantasyPoints_gm, data = wr_gm)
ReceivingTD_gm_model <- lm(ReceivingTD_gm ~ FantasyPoints_gm, data = wr_gm)
ReceivingYds_gm_model <- lm(ReceivingYds_gm ~ FantasyPoints_gm, data = wr_gm)
...
```{r}
#WR Linear Models
Tgt_gm_model <- lm(Tgt_gm ~ FantasyPoints_gm, data = te_gm)
Rec_gm_model <- lm(Rec_gm ~ FantasyPoints_gm, data = te_gm)
ReceivingTD_gm_model <- lm(ReceivingTD_gm ~ FantasyPoints_gm, data = te_gm)
ReceivingYds_gm_model <- lm(ReceivingYds_gm ~ FantasyPoints_gm, data = te_gm)
