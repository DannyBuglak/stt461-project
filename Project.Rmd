...
```{r}
#QB Linear Models
PassingTD_gm_model <- lm(FantasyPoints_gm ~ PassingTD_gm, data = qb_gm)
PassingYds_gm_model <- lm(FantasyPoints_gm ~ PassingYds_gm, data = qb_gm)
GS_model <- lm(FantasyPoints_gm ~ GS, data = qb_gm)
PassingAtt_gm_model <- lm(FantasyPoints_gm ~ PassingAtt_gm, data = qb_gm)

# Adjusted R squared values
PassingTD_summary <- summary(PassingTD_gm_model)
adjusted_r_squared <- PassingTD_summary$adj.r.squared
adjusted_r_squared

PassingYds_summary <- summary(PassingYds_gm_model)
adjusted_r_squared <- PassingYds_summary$adj.r.squared
adjusted_r_squared

PassingAtt_summary <- summary(PassingAtt_gm_model)
adjusted_r_squared <- PassingAtt_summary$adj.r.squared
adjusted_r_squared

GS_summary <- summary(GS_model)
...
```{r}
#RB Linear Models
Tgt_gm_model <- lm(FantasyPoints_gm ~ Tgt_gm, data = rb_gm)
Rec_gm_model <- lm(FantasyPoints_gm ~ Rec_gm, data = rb_gm)
RushingYds_gm_model <- lm(FantasyPoints_gm ~ RushingYds_gm, data = rb_gm)
RushingTD_gm_model <- lm(FantasyPoints_gm ~ RushingTD_gm, data = rb_gm)
RushingAtt_gm_model <- lm(FantasyPoints_gm ~ RushingAtt_gm, data = rb_gm)
ReceivingYds_gm_model <- lm(FantasyPoints_gm ~ ReceivingYds_gm, data = rb_gm)
ReceivingTD_gm_model <- lm(FantasyPoints_gm ~ ReceivingTD_gm, data = rb_gm)
GS_model <- lm(FantasyPoints_gm ~ GS, data = rb_gm)


# Adjusted R squared values
RushingYds_gm_summary <- summary(RushingYds_gm_model)
adjusted_r_squared <- RushingYds_gm_summary$adj.r.squared
adjusted_r_squared

RushingAtt_gm_summary <- summary(RushingAtt_gm_model)
adjusted_r_squared <- RushingAtt_gm_summary$adj.r.squared
adjusted_r_squared

Rec_gm_summary <- summary(Rec_gm_model)
adjusted_r_squared <- Rec_gm_summary$adj.r.squared
adjusted_r_squared

Tgt_gm_summary <- summary(Tgt_gm_model)
adjusted_r_squared <- Tgt_gm_summary$adj.r.squared
adjusted_r_squared

ReceivingYds_gm_summary <- summary(ReceivingYds_gm_model)
adjusted_r_squared <- ReceivingYds_gm_summary$adj.r.squared
adjusted_r_squared

RushingTD_gm_summary <- summary(RushingTD_gm_model)
...
ReceivingTD_gm_summary <- summary(ReceivingTD_gm_model)
...
```{r}
#WR Linear Models
GS_model <- lm(FantasyPoints_gm ~ GS, data = wr_gm)
Tgt_gm_model <- lm(FantasyPoints_gm ~ Tgt_gm, data = wr_gm)
Rec_gm_model <- lm(FantasyPoints_gm ~ Rec_gm, data = wr_gm)
ReceivingTD_gm_model <- lm(FantasyPoints_gm ~ ReceivingTD_gm, data = wr_gm)
ReceivingYds_gm_model <- lm(FantasyPoints_gm ~ ReceivingYds_gm, data = wr_gm)
...
```{r}
#TE Linear Models
Tgt_gm_model <- lm(FantasyPoints_gm ~ Tgt_gm, data = te_gm)
Rec_gm_model <- lm(FantasyPoints_gm ~ Rec_gm, data = te_gm)
ReceivingTD_gm_model <- lm(FantasyPoints_gm ~ ReceivingTD_gm, data = te_gm)
ReceivingYds_gm_model <- lm(FantasyPoints_gm ~ ReceivingYds_gm, data = te_gm)
